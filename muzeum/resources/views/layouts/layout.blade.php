    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid mx-5">
                <a class="navbar-brand" href="{{route('items.index')}}">Múzeum</a>
                <button
                ...
                <div class="collapse navbar-collapse" id="main-navbar">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('toform')}}">Új címke</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('labeloperations')}}">Címke módosítása / Listázása</a>
                        </li>
                        {{-- <li class="nav-item">
